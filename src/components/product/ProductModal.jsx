...
const ProductModal = () => {
    ...
    const StyledDiv = styled.div`
        ...
        .bg__img {
            ...
            background-image: ${targetProduct.imageLarge ? `url(${targetProduct.imageLarge[0].url})` : baoImg};
            ...
            >
                <div className="container container--introduce">
                    <div className="breadcumb h6 po-ab">
                        商品一覽 / <span>{`${getCategoryName()} / ${targetProduct.name}`}</span>
                    </div>
                    <svg
                        role="button"
                        aria-label="close"
                    ...
                    >
                        ...
                        <line x1="15" y1="35" x2="35" y2="15" stroke="#7a031f" strokeWidth="3" strokeLinecap="round" />
                    </svg>
                    <div className="introduce">
                        ...
                        <div>
                            ...
                            <ul className="h6">
                                <li>成分：麵粉、老麵{targetProduct && getIngredient()}、沙拉油、水、糖、鹽</li>
