...
const rankProducts = [
  {
    ...
    price: 35,
    details:
      '入口綿密的豆沙，搭配彈牙的手桿老麵外皮，點心界經典中的經典，長年小豆包子的銷售排行榜冠軍。',
    imgURL: popImg1,
  },
  {
    title: '黑糖芝麻包',
    price: 35,
    details:
      '濃郁爆醬的黑芝麻餡，讓你一口成為老饕，選用台糖5號的天然黑糖，微甜不膩，襯托出黑芝麻的香味。',
    imgURL: popImg2,
  },
  {
    title: '牛奶芋泥包',
    price: 35,
    details:
      '香氣四溢的芋頭味，大人小孩的最愛，芋頭餡綿密不死甜，芋頭控不能錯過的點心。',
    imgURL: popImg4,
  },
  {
    title: '芝麻花生包',
    price: 35,
    details:
      '選用國產的上等落花生做成的天然花生醬，小豆包子的獨家口味，長年小豆包子的銷售排行榜亞軍。',
    imgURL: popImg3,
  },
  {
    title: '胚芽起司包',
    price: 35,
    details:
      '爆醬起司配上胚芽的香氣，外表看似單調，內涵卻很豐富，適合當健身族的早餐或點心。',
    imgURL: popImg5,
  },
];
