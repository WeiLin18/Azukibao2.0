  ...
  return (
    ...
    <div className="container">
      ...
      {promotionLayout && promotionLayout === 'material'?
        ...
        <a href="products.index" className="promotion__item__link">
          <img src={materialSvg} alt="products" className="promotion__item__pic" />
          <div>
            <h3 className="promotion__item__title">嚴選食材</h3>
            <p className="promotion__item__details">了解小豆包子<br />堅持選用的頂級食材</p>
          </div>
        </a>
      </li>):
      (<li className="promotion__item">
      <a href="products.html" className="promotion__item__link">
        <div className="promotion__item__pic">
          <img src={productSvg} alt="products" className="promotion__item__pic__img" />
        ...
        <div>
          ...
          <p className="promotion__item__details">看更多不同口味<br />超好吃的包子和饅頭</p>
        </div>
      </a>
    </li>)
      }
        ...
        <li className="promotion__item">
          <a href="shop.html" className="promotion__item__link">
            <div className="promotion__item__pic mr-5 mt-10 mt-2l-0">
              <img src={shopBodySvg} alt="shop" className="promotion__item__pic__img " />
              <img src={shopPlateSvg} alt="shop" className=" promotion__item__pic__img--shop" />
            </div>
            <div>
              <h3 className="promotion__item__title">店鋪情報</h3>
              <p className="promotion__item__details">了解小豆包子<br />實體門市的相關資訊</p>
            </div>
          </a>
        </li>
      </ul>
