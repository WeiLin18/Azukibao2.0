...
const halfFeatures = [
    {
        title: '老麵的香氣與彈牙的外皮',
        details: '使用古法發酵技術發酵的天然老麵，讓包子外皮帶有天然的香氣與彈牙的口感',
        imgURL: halfImg1
    },
    {
        title: '小火慢煮的紅豆沙',
        details: '4小時的小火拌煮，讓粒粒紅豆軟化到透心，再經過3道雜質濾淨，萃取出精華的紅豆沙',
        imgURL: halfImg2
    },
    {
        title: '外皮與餡料的黃金比例',
        details: '充份摺疊的揉麵技術，外皮與餡料的完美比例，打造有層次的味覺與嗅覺饗宴',
        imgURL: halfImg3
    },
]
                ...
                <div className="introduce">
                    ...
                    <ul>
                        {halfFeatures.map((halfFeature, index) => {
                            return (
                                <PopularHalfItem halfInfo={halfFeature} key={index} />
                            )
                        })}
                    </ul>
                </div>
